            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <form method="post" action="{{url('/add-cabinet')}}" enctype="multipart/form-data">
                        @method("post")
                        @csrf
                        ...
                        <div class="row mb-5  pt-3" >
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"  id="adresse" name="adresse"  value="{{ (old('adresse')!== null)?old('adresse'):(isset($oldValues)?$oldValues['adresse']:'') }}"   required>
                        ...
                        <div class="row mb-5">
                            <div class="col-sm-4">
                                <div>
                                    ...
                                    <input type="text" class="form-control" name="firmName"   placeholder=" اسم مكتب المحامي "   value="{{ (old('firmName')!== null)?old('firmName'):(isset($oldValues)?$oldValues['firmName']:'') }}"  required >
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" name="dateCreation"   placeholder=" التاريخ"   value="{{ (old('dateCreation')!== null)?old('dateCreation'):(isset($oldValues)?$oldValues['dateCreation']:'') }}"   required>
                                </div>
                            </div><!-- Col -->
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    <label class="form-label"> <span class="text-danger"> *</span>المقر الرئيسي للمكتب</label>
                                    <input type="text" class="form-control" name="siege"   placeholder=" المقر الرئيسي"   value="{{ (old('siege')!== null)?old('siege'):(isset($oldValues)?$oldValues['siege']:'') }}"   required>
                                </div>
                            </div><!-- Col -->
                                ...
                                <div class="col-md-6 stretch-card mx-auto">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <input type="file" name="logo"  value="{{ (old('logo')!== null)?old('logo'):(isset($oldValues)?$oldValues['logo']:'') }} " id="myDropify" accept="image/*" />
                                        </div>
                                    </div>
                                </div>
                            </div>
