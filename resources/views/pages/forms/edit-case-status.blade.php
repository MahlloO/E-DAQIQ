            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <form method="post" action="{{url('edit-caseStatus',$dossier->id)}}">
                        @method("put")
                        @csrf
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="mb-3">
                                <label class="form-label bold">  <span class="text-danger"> *</span>رقم القرار</label>
                                <div class=" " style="display: flex; flex-shrink: 1; gap:5px">

                                    <div>
                                        <input type="text" class="form-control" name="numberDecision"   placeholder=" رقم"   value="{{ (old('numberDecision')!== null)?old('numberDecision'):(isset($oldValues)?$oldValues['numberDecision']:$dossier->numDecision) }}"  required>

                                    </div>

                                    <div>
                                        <input type="text" class="form-control" name="yearDecision"   placeholder=" السنة"   value="{{ (old('yearDecision')!== null)?old('yearDecision'):(isset($oldValues)?$oldValues['yearDecision']:$dossier->dateDecision) }}" minlength="4" maxlength="4"  required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3">
                                    <label class="form-label bold"><span class="text-danger"> *</span>تقرير القاضي</label>

                                    <textarea class="form-control" name="tinymce" id="tinymceExample"  rows="2">

                                            {{ (old('tinymce') !== null) ? old('tinymce') : (isset($oldValues) ? $oldValues['tinymce'] : $dossier->jugeRapporteur) }}
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3">
                                    <label class="form-label bold"><span class="text-danger"> *</span>طبيعة اختصاص الملف</label>
                                    <div class=" " style="display: flex; flex-shrink: 1; gap:5px">

                                        <input type="text" name="terme" id="type-input" placeholder="طبيعة اختصاص الملف" value="{{ (old('terme')!== null)?old('terme'):(isset($oldValues)?$oldValues['terme']:(isset($nature->typeDossier)?$nature->typeDossier:'')) }}" class="form-control" autocomplete="off"><br>
