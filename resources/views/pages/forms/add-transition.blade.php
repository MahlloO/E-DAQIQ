            ...
            <div class="card">
                <div class="card-body w-auto d-flex align-items-center">
                    ...
                    <div class="d-flex justify-content-center w-100">
                        ...
                        <form method="post" action="{{url('/add-transition',$note)}}" class="mx-auto w-100">
                            @method("post")
                            @csrf
                                    ...
                                    <div class="row mx-auto m-lg-3 mb-5">
                                        <div class="p-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control p-2" id="montantC" name="montantC" value="{{ (old('montantC')!== null)?old('montantC'):(isset($oldValues)?$oldValues['montantC']:'') }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mx-auto m-lg-3 mb-5">
                                        <div class="">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select form-select-lg mb-2 p-2" name="typePaiment" id="mySelect" required>
                                                    <option value="Cheque" {{ (isset($oldValues) and $oldValues['typeFrais']  ===  "Cheque"  ) ? 'selected' : '' }}>
                                                        Cheque
                                                    </option>
                                                    <option value="Espece" {{ (isset($oldValues) and $oldValues['typeFrais']  ===  "Espece"  ) ? 'selected' : '' }}>
                                                        Espece
                                                    </option>
                                                </select>
                                            </div>
