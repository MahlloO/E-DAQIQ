            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <form method="post" action="{{url('/edit-fees',$Honoraires->id)}}">
                        @method("put")
                        @csrf
                                ...
                                <div class="row mx-auto m-lg-3 mb-5" >
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control"  id="montantC" name="montantC"   value="{{ (old('montantC')!== null)?old('montantC'):(isset($oldValues)?$oldValues['montantC']:$Honoraires->amounInFigure) }}"   required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label class="form-label"> <span class="text-danger"> *</span> المبلغ بالحروف</label>
                                            <input type="text" class="form-control"   id="montantL" name="montantL"  value=" {{ (old('montantL')!== null)?old('montantL'):(isset($oldValues)?$oldValues['montantL']:$Honoraires->amounInWorld) }}"    required>
                                        </div>
                                    </div><!-- Col -->
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label"><span class="text-danger"> *</span> نوع الرسوم </label>
                                                ...
                                                @foreach($types as $type)
                                                    <option value="{{$type->id}}" {{ ((isset($oldValues) and $oldValues['typeHonoraire']   ===  $type->typeHonoraire ) or $Honoraires->type_id ==$type->id) ? 'selected' : '' }}>
                                                        {{$type->typeHonoraire}}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select form-select-lg mb-2"   name="natureHonoraire"  id="mySelect">
                                                    <option value="Avance" {{ $Honoraires->nature == "Avance" ? 'selected' : '' }}>
                                                       Avance
                                                    </option>
                                                    <option value="Complément" {{ $Honoraires->nature ==  'Complément'   ? 'selected' : '' }}>
                                                       Complément
                                                    </option>
