        ...
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                        <button name="add" class="btn btn-primary submit mt-2" onclick="duplicateInputs()">إضافة تكاليف اخرى</button>

                        <form method="post" action="{{url('/add-cost',$dossier_id)}}">
                        @method("post")
                        @csrf
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select form-select-lg mb-2"   name="typeFrais[]"  id="mySelect">
                                                @foreach($natures as $nature)
                                                    <option value="{{$nature}}" {{ (isset($oldValues) and $oldValues['typeFrais']  ===  $nature  ) ? 'selected' : '' }}>
                                                        {{$nature}}
                                                    </option>
                                                @endforeach
                                            </select>
