<nav class="sidebar">
  <div class="sidebar-header align-center">
    <a href="#" class="sidebar-brand mt-1">
       <img src="{{ asset("/img/logo.png") }}" class="pt-1" style="height: 100px">
    </a>
  ...
  <div class="sidebar-body">
    <ul class="nav">
        @canany(['manage-assistant','all','Clients','addClient','editClient','deleteClient','Cases','addCase','editCase','deleteCase','Invoices','addInvoice','editInvoice','deleteInvoice'])
        ...
        @endcanany
        @canany(['all','Clients','addClient','editClient','deleteClient'])
        <li class="nav-item nav-category fs-6">الزبائن</li>
        @endcanany
        <li class="nav-item {{ active_class(['/']) }}">
        @canany(['Clients','all'])
        ...
        @endcanany
        @canany(['addClient','all'])
            <a href="{{ url('/addClient') }}" class="nav-link">
              <i class="link-icon" data-feather="user-plus"></i>
              <span class="link-title">إضافة عميل</span>
            </a>
        @endcanany
      </li>
        @canany(['all','Cases','addCase','editCase','deleteCase'])
        <li class="nav-item nav-category fs-6">القضايا</li>
        @endcanany
        <li class="nav-item {{ active_class(['/']) }}">
            @canany(['Cases','all'])
            <a href="{{ url('/cases') }}" class="nav-link">
                <i class="link-icon" data-feather="folder-minus"></i>
                <span class="link-title">القضايا</span>
            </a>
            @endcanany
            @canany(['addCase','all'])
                <a href="{{ url('/add-case') }}" class="nav-link">
                    <i class="link-icon" data-feather="folder-plus"></i>
                    <span class="link-title"> إضافة قضية</span>
                </a>
            @endcanany
        </li>
        @can('manage-assistant')
        <li class="nav-item nav-category fs-6">إدارة المساعدين</li>
             <li class="nav-item {{ active_class(['/']) }}">
                 <a href="{{ url('/membres') }}" class="nav-link">
                     <i class="link-icon" data-feather="users"></i>
                     <span class="link-title">المساعدين</span>
                 </a>

                 <a href="{{ url('/add-member') }}" class="nav-link">
                     <i class="link-icon" data-feather="user-plus"></i>
                     <span class="link-title"> إضافة مساعد</span>
                 </a>
            </li>
        @endcan
        @can('Invoices')
        <li class="nav-item nav-category fs-6">إدارة الفواتير</li>

         <li class="nav-item {{ active_class(['/']) }}">
             <a href="{{ url('/invoices') }}" class="nav-link">
                 <i class="link-icon" data-feather="file-text"></i>
                 <span class="link-title">الفواتير</span>
             </a>
        </li>
        @endcan
        @can('admin')
            ...
            <li class="nav-item nav-category fs-6">إدارة المكاتب</li>

            <li class="nav-item {{ active_class(['/']) }}">
                <a href="{{ url('/firms') }}" class="nav-link">
                    <i class="link-icon" data-feather="trello"></i>
                    <span class="link-title">المكاتب</span>
                </a>
                <a href="{{ url('/add-cabinet') }}" class="nav-link">
                    <i class="link-icon" data-feather="plus-square"></i>
                    <span class="link-title"> إضافة مكتب</span>
                </a>
            </li>
            <li class="nav-item nav-category fs-6">إدارة الموارد المشتركة</li>
            <li class="nav-item {{ active_class(['/']) }}">
                <a href="{{ url('/natureJudiciare') }}" class="nav-link">
                    <i class="link-icon" data-feather="file-text"></i>
                    <span class="link-title">قوانين ملف الاختصاص</span>
                </a>
                <a href="{{ url('/add-nature') }}" class="nav-link">
                    <i class="link-icon" data-feather="file-plus"></i>
                    <span class="link-title"> إضافة قانون ملف الاختصاص</span>
                </a>
...
{{--          <span class="link-title">التقويم  </span>--}}
{{--        </a>--}}
{{--      </li>--}}
...
{{--      </li>--}}
      ...
      <li class="nav-item pt-3">
        <a href="/logout"  class="nav-link">
          ...
          <span class="link-title">تسجيل خروج</span>
        </a>
      </li>
    </ul>
  </div>
