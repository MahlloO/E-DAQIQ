            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-baseline">
                        <h6 class="card-title mb-0"> عدد المكاتب</h6>

                    </div>
                    <div class="row">
                        <div class="col-6 col-md-12 col-xl-5">
                            <h3 class="mb-2">{{ \App\Models\Cabinet::count() }}</h3>
        ...
        <div class="col-md-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-6 col-md-12 col-xl-5">
                            <h3 class="mb-2">{{ \App\Models\Clients::count() }}</h3>
                            <div class="d-flex align-items-baseline">
                                <p class="text-success">
{{--                                    <span>+3.3%</span>--}}
                                    <i data-feather="arrow-up" class="icon-sm mb-1"></i>
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-baseline">
              <h6 class="card-title mb-0"> عدد القضايا </h6>
              <div class="dropdown mb-2">
  ...
  <div class="col-lg-7 col-xl-8 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <div id="monthlySalesChartRTL1"></div>
      </div>
    </div>
  </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-6">
            <div>
              ...
              <h5 class="fw-bolder mb-0">{{ $count1 }}</h5>
            </div>
          </div>
        </div>
